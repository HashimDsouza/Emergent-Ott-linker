      ...
      >
        ...
        <div className="relative h-full flex flex-col justify-end pb-6 px-6 md:px-10" style={{ paddingTop: "60%" }}>
          <div className="max-w-md">
            ...
            <p className="italic text-white/90 text-sm md:text-base mt-0.5">"{hero.tagline}"</p>
            
            {/* Line 3: Platform + Rating */}
            <div className="mt-1.5 flex items-center gap-2 text-xs">
              <span className="text-[9px] px-1.5 py-0.5 rounded-full bg-white/10 border border-white/15">{hero.platform}</span>
              <span className="text-white/85">⭐ {hero.rating}</span>
            </div>
            
            {/* Line 4: Buzz Meter */}
            <div className="mt-2 flex items-center gap-2 text-[10px] uppercase tracking-wider opacity-85">
              ...
              >
                <svg width="14" height="14" viewBox="0 0 24 24"><path fill="#FF0000" d="M23.5 6.2a4 4 0 0 0-2.8-2.8C18.9 3 12 3 12 3s-6.9 0-8.7.4A4 4 0 0 0 .5 6.2 41.6 41.6 0 0 0 0 12a41.6 41.6 0 0 0 .5 5.8 4 4 0 0 0 2.8 2.8C5.1 21 12 21 12 21s6.9 0 8.7-.4a4 4 0 0 0 2.8-2.8A41.6 41.6 0 0 0 24 12a41.6 41.6 0 0 0-.5-5.8Z"/><path fill="#fff" d="m10 15 6-3-6-3v6z"/></svg>
              </a>
              <a 
                ...
                title="Buzzing on X"
              >
                <svg width="14" height="14" viewBox="0 0 24 24"><path fill="#ffffff" d="M18.146 2H21l-6.5 7.43L22.5 22h-6.59l-5.16-6.64L4.7 22H2l6.97-7.97L1.5 2H8.09l4.66 6L18.146 2Zm-2.31 18.5h1.71L7.25 3.46H5.43l10.41 17.04Z"/></svg>
              </a>
              <a 
