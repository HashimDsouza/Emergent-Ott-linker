    ...
    >
      ...
      <div className="relative flex items-center justify-between gap-4 md:gap-6 px-3 md:px-6 py-2 md:py-2.5">
        ...
        <div className="flex gap-1.5 md:gap-3 flex-1 justify-center">
          <Chip icon={Play} label="Watch On" subline="All Your Apps. One Tap Away" onClick={() => navigate('/watch-on')} />
          <Chip icon={Flame} label="Buzz Meter" subline="The Internet is Talking.." onClick={() => navigate('/buzz-meter')} />
          <div className="hidden md:block">
            <Chip icon={Target} label="Win" subline="Flex your fandom. Score some cred." />
          </div>
        </div>
      ...
      <div className="relative px-3 md:px-6 pb-2 md:pb-2.5">
        <div className="flex gap-2 md:gap-3 justify-center">
          <Chip icon={Trophy} label="Game On" subline="Live Action Real Drama" onClick={() => navigate('/game-on')} />
          <Chip icon={Clapperboard} label="Entertainment" subline="Whatever your vibe. I've got you." onClick={() => navigate('/entertainment')} />
          <LanguageDropdown />
        </div>
      </div>
    </header>
...
export function ConnectorFooter() {
  ...
  return (
    <>
      ...
      <footer
        data-footer
        className="fixed bottom-0 left-0 right-0 z-50 backdrop-blur-md border-t overflow-hidden"
        style={{ 
          backgroundColor: `${charcoal}F5`,
