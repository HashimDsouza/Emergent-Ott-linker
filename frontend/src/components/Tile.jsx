  ...
  return (
    <div onClick={handleClick} className="relative block rounded-lg md:rounded-xl overflow-hidden shadow-lg border border-white/10 hover:-translate-y-0.5 transition cursor-pointer">
      ...
      <div className="absolute inset-x-0 bottom-0 px-1.5 pb-1.5 md:px-3 md:pb-3 text-white">{/* Line 1: Platform + social icons (heart, thumbs, comments) */}
        ...
        <div className="flex items-center gap-1 md:gap-1.5 uppercase tracking-wide opacity-85 mb-0.5 md:mb-1 text-[7px] md:text-[10px]">
          ...
          >
            <svg width="9" height="9" className="md:w-[14px] md:h-[14px]" viewBox="0 0 24 24"><path fill="#FF0000" d="M23.5 6.2a4 4 0 0 0-2.8-2.8C18.9 3 12 3 12 3s-6.9 0-8.7.4A4 4 0 0 0 .5 6.2 41.6 41.6 0 0 0 0 12a41.6 41.6 0 0 0 .5 5.8 4 4 0 0 0 2.8 2.8C5.1 21 12 21 12 21s6.9 0 8.7-.4a4 4 0 0 0 2.8-2.8A41.6 41.6 0 0 0 24 12a41.6 41.6 0 0 0-.5-5.8Z"/><path fill="#fff" d="m10 15 6-3-6-3v6z"/></svg>
          </a>
          <a 
            ...
            onClick={(e) => e.stopPropagation()}
          >
            <svg width="9" height="9" className="md:w-[14px] md:h-[14px]" viewBox="0 0 24 24"><path fill="#ffffff" d="M18.146 2H21l-6.5 7.43L22.5 22h-6.59l-5.16-6.64L4.7 22H2l6.97-7.97L1.5 2H8.09l4.66 6L18.146 2Zm-2.31 18.5h1.71L7.25 3.46H5.43l10.41 17.04Z"/></svg>
          </a>
          <a 
