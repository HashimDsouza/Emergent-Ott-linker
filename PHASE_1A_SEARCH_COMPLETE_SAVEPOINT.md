...
- Frontend: Port 3000
- External URL: https://connector-app.preview.emergentagent.com
...
4. **Re-seed content:**
   ```bash
   curl -X POST https://connector-app.preview.emergentagent.com/api/content/seed
   ```

5. **Re-enrich content:**
   ```bash
   curl -X POST https://connector-app.preview.emergentagent.com/api/enrich-all-content
   ```
