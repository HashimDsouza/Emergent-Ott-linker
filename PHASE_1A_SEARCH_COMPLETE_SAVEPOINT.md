...
- Frontend: Port 3000
- External URL: https://connector-hub-2.preview.emergentagent.com
...
4. **Re-seed content:**
   ```bash
   curl -X POST https://connector-hub-2.preview.emergentagent.com/api/content/seed
   ```

5. **Re-enrich content:**
   ```bash
   curl -X POST https://connector-hub-2.preview.emergentagent.com/api/enrich-all-content
   ```
